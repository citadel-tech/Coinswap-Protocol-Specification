# OpenSwap Protocol Documentation
This repository contains the complete documentation for the **OpenSwap Protocol**, an atomic swap protocol that enables trustless atomic swaps through a decentralized, Sybil-resistant marketplace using Bitcoin-based fidelity bonds. This documentation provides an in-depth overview of the protocol's architecture, functionality, and other important details.
...
3. [Protocol Flow](./v1%20protocol/protocol-flow.md): A Step-by-Step description of a OpenSwap.
...
3. [Protocol Flow](./v2%20protocol/protocol-flow.md): Step-By-Step description of a Taproot–MuSig2 OpenSwap.

### General Documents

All other general documents that applies to both the protocols are as follows:

1. [Introduction](./general%20specs/introduction.md): An overview of the OpenSwap Protocol, its history, and core features.
2. [Architecture](./general%20specs/architecture.md): An overview of the OpenSwap server, client and the marketplace.
3. [Fidelity](./general%20specs/fidelity.md): Explanation of fidelity bonds and their role in the protocol.
4. [Fees](./general%20specs/fees.md): Overview of how fees are structured and accounted for within OpenSwap transactions.
